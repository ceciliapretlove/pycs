...
@endif
   ...
   <!--             <li>
      <a><i class="metismenu-icon pe-7s-car"></i>
      Assets Group
      <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
      </a>
      <ul>
         <li>
            <a href="/equipment-category"><i class="metismenu-icon"></i>
            Equipment Category
            </a>
         </li>
         <li>
            <a href="/equipment-type"><i class="metismenu-icon"></i>
            Equipment Type
            </a>
         </li>
      </ul>
      ...
      <li>
      <a><i class="metismenu-icon pe-7s-box2"></i>
      Warehouse Inventory
      <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
      </a>
      <ul>
         <li>
            <a href="/warehouseInventory">
            <i class="metismenu-icon"></i>
            Spare Part / Material
            </a>
         </li>
...
<!--    <li>
   ...
   <!-- system variables -->
          ...
          @elseif(auth()->user()->role == 1)
            ...
            <!-- 21CARGO  -->
<!--                <li class="app-sidebar__heading">Equipment Management
                  <li>
                     <a href="/equipmentRegister">
                     <i class="metismenu-icon pe-7s-note"></i>
                     Equipment Registration
                     </a>
                  </li>
                  </li>
                  <li class="app-sidebar__heading">Operations Management
                  <li>
                     <a href="/accountManagement">
                     <i class="metismenu-icon"></i>
                     Account Management
            ...
            <li>
               ...
               <li>
               <a href="/proManagement"><i class="metismenu-icon pe-7s-graph"></i>
               PRO Number 
               </a>
            </li>
            <li>
...
<!--             <li class="app-sidebar__heading">Equipment Management
            ...
            <li class="app-sidebar__heading">Operations Management
            <li>
               <a href="/dispatchUtilizationTripping">
               <i class="metismenu-icon pe-7s-config"></i>
               Operations & Utilization
               </a>
            </li>
            </li>
            <li class="app-sidebar__heading">Preventive & Corrective
            <li>
               <a href="/preventivemaintenance">
               <i class="metismenu-icon pe-7s-config"></i>
               Preventive & Corrective
               </a>
            </li>
            </li>
         <li class="app-sidebar__heading">Corrective Maintenance
               <li>
                  <a>
                     <i class="metismenu-icon pe-7s-config"></i>
                     Operations & Utilization
               ...
               <li class="app-sidebar__heading">Corrective Maintenance
                  ...
                  <li class="app-sidebar__heading">Job Order
                  <li>
                     <a href="/joborder">
                     <i class="metismenu-icon pe-7s-config"></i>
                  ...
                  <li>
                     <a href="/equipmentoverview">
                     <i class="metismenu-icon pe-7s-shuffle"></i>
                     Equipment Overview
                     </a>
                  </li>
                  <li>
                     <a href="/equipmentstatus">
