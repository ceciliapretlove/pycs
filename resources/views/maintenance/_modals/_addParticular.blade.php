<div class="modal fade" id="addParticularModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
   <div class="modal-dialog modal-md">
      <div class="modal-content">
         <div class="modal-header">
            <small><b>Add Particular</b></small>
         </div>
         <form id="addParticularForm" method="post">
            {{ csrf_field() }}
            {{ method_field('post') }}
