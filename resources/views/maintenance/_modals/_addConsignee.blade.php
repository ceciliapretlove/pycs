<div class="modal fade" id="addConsigneeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
   <div class="modal-dialog modal-md">
      <div class="modal-content">
         <div class="modal-header">
            <small><b>Add Consignee</b></small>
         </div>
         <form id="addConsigneeForm" method="post">
            {{ csrf_field() }}
            {{ method_field('post') }}
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group border-title">
                        ...
                        <textarea class="form-control" id="consignee_address" name="consignee_address"rows="4"></textarea> 
                        <small class='error-message' id="error-title"></small>
                     </div>
                  </div>
               </div>
