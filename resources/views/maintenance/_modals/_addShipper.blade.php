<div class="modal fade" id="addShipperModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
   <div class="modal-dialog modal-md">
      <div class="modal-content">
         <div class="modal-header">
            <small><b>Add Shipper</b></small>
         </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="form-group border-title">
                        ...
                        <textarea class="form-control" id="shipper_address" name="shipper_address"rows="4"></textarea> 
                        <small class='error-message' id="error-title"></small>
                     </div>
                  </div>
               </div>
