...
<!--       <div class="eduction-area pb-70">
         <div class="container-fluid p-0">
            <div class="row g-0">
               <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200" data-aos-once="true">
               ...
               <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400" data-aos-once="true">
               ...
               <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600" data-aos-once="true">
               ...
               <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="800" data-aos-once="true">
                     ...
                     <div class="counter">
                        <div class="row">
                           ...
                           <div class="col-lg-4 col-4">
                              <div class="counter-card">
                                 <h1>
                                    <span class="odometer odometer-auto-theme" data-count="52">
...
<!--       <div class="courses-area pt-100 pb-70 bg-f4f6f9">
         <div class="container">
            ...
            <div class="courses-slider style-2 owl-carousel owl-theme owl-loaded owl-drag">
               <div class="owl-stage-outer">
                  <div class="owl-stage" style="transform: translate3d(-1768px, 0px, 0px); transition: all 0s ease 0s; width: 6630px;">
               ...
               <div class="owl-nav"><button type="button" role="presentation" class="owl-prev" fdprocessedid="qc354"><i class="ri-arrow-left-line"></i></button><button type="button" role="presentation" class="owl-next" fdprocessedid="iukfi"><i class="ri-arrow-right-line"></i></button></div>
      ...
      <div class="campus-life-area ptb-100">
         <div class="container">
            ...
            <div class="campus-slider2 owl-carousel owl-theme owl-loaded owl-drag">
               <div class="owl-stage-outer">
                  <div class="owl-stage" style="transition: all 0s ease 0s; width: 4420px; transform: translate3d(-884px, 0px, 0px);">
                     <div class="owl-item cloned" style="width: 412px; margin-right: 30px;">
                     ...
                     <div class="owl-item active center" style="width: 412px; margin-right: 30px;">
                        <div class="single-campus-card style-3">
                           <div class="img">
               ...
               <div class="owl-nav"><button type="button" role="presentation" class="owl-prev" fdprocessedid="kw11f5"><i class="ri-arrow-left-line"></i></button><button type="button" role="presentation" class="owl-next" fdprocessedid="q40eo"><i class="ri-arrow-right-line"></i></button></div>
               <div class="owl-dots disabled"></div>
            </div>
         </div>
      </div>
      ...
      <div class="health-care-area pt-100 pb-70 bg-f4f6f9">
         <div class="container">
            ...
            <div class="health-care-slider owl-carousel owl-theme owl-loaded owl-drag">
               <div class="owl-stage-outer">
                  <div class="owl-stage" style="transform: translate3d(-1326px, 0px, 0px); transition: all 0s ease 0s; width: 4420px;">
                     <div class="owl-item cloned" style="width: 412px; margin-right: 30px;">
                        <div class="single-health-care-card style-3">
                           <div class="img">
                              <a href="health-care-details.html"><img src="assets/images/health-care/health-care-6.jpg" alt="Image"></a>
                           </div>
                     ...
                     <div class="owl-item cloned" style="width: 412px; margin-right: 30px;">
                        <div class="single-health-care-card style-3">
                           <div class="img">
                              <a href="health-care-details.html"><img src="assets/images/health-care/health-care-7.jpg" alt="Image"></a>
                           </div>
                           <div class="health-care-content">
                              <a href="health-care-details.html">
                     ...
                     <div class="owl-item active" style="width: 412px; margin-right: 30px;">
                        <div class="single-health-care-card style-3">
                           <div class="img">
                              <a href="health-care-details.html"><img src="assets/images/health-care/health-care-5.jpg" alt="Image"></a>
                           </div>
                           <div class="health-care-content">
                              <a href="health-care-details.html">
               ...
               <div class="owl-nav"><button type="button" role="presentation" class="owl-prev" fdprocessedid="i0mf24"><i class="ri-arrow-left-line"></i></button><button type="button" role="presentation" class="owl-next" fdprocessedid="62xks"><i class="ri-arrow-right-line"></i></button></div>
               <div class="owl-dots disabled"></div>
            </div>
         </div>
      </div>
      <div class="events-area pt-100 pb-70">
         <div class="container">
            ...
            <div class="events-slider owl-carousel owl-theme owl-loaded owl-drag">
               <div class="owl-stage-outer">
                  <div class="owl-stage" style="transform: translate3d(-1326px, 0px, 0px); transition: all 0s ease 0s; width: 4420px;">
                     <div class="owl-item cloned" style="width: 412px; margin-right: 30px;">
                           ...
                           <div class="events-content">
                              ...
                              <div class="date-and-read-more">
                                 <ul class="d-flex justify-content-between">
                                    ...
                                    <li>
                                       <a href="events-details.html" class="read-more-btn active">Read Article<i class="flaticon-next"></i></a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
               ...
               <div class="owl-nav"><button type="button" role="presentation" class="owl-prev" fdprocessedid="s2k2d9"><i class="ri-arrow-left-line"></i></button><button type="button" role="presentation" class="owl-next" fdprocessedid="x1xcem"><i class="ri-arrow-right-line"></i></button></div>
               <div class="owl-dots"><button role="button" class="owl-dot active" fdprocessedid="gpu9m"><span></span></button><button role="button" class="owl-dot" fdprocessedid="duol25"><span></span></button></div>
            </div>
         </div>
      </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-8">
                  ...
                  <div class="row">
                     <div class="col-lg-6 col-md-6 aos-init" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200" data-aos-once="true">
                     ...
                     <div class="col-lg-6 col-md-6 aos-init" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400" data-aos-once="true">
                        <div class="single-podcasts-card style3">
                           <div class="podcasts-image">
                     ...
                     <div class="col-lg-6 col-md-6 aos-init" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600" data-aos-once="true">
                        <div class="single-podcasts-card style3">
                           <div class="podcasts-image">
                     ...
                     <div class="col-lg-6 col-md-6 aos-init" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="800" data-aos-once="true">
                        <div class="single-podcasts-card style3">
                           <div class="podcasts-image">
               ...
               <div class="col-lg-4">
                  ...
                  <div class="subscribe-area">
                     ...
                     <form class="newsletter-form" data-toggle="validator" novalidate="true">
                        <input type="email" class="form-control" placeholder="Your Email" name="EMAIL" required="" autocomplete="off" fdprocessedid="rnrfjn">
                        <button class="default-btn disabled" type="submit" style="pointer-events: all; cursor: pointer;" fdprocessedid="qs3q2k">
                        Subscribe
                        </button>
      ...
      <div class="students-stories-area pt-100 pb-70">
         <div class="container">
            ...
            <div class="row justify-content-center">
               <div class="col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200" data-aos-once="true">
               ...
               <div class="col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400" data-aos-once="true">
                  <div class="single-stories-card style2">
                     <div class="stories-content">
               ...
               <div class="col-lg-4 col-md-6 aos-init" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600" data-aos-once="true">
                  <div class="single-stories-card style2">
                     <div class="stories-content">
      ...
      <div class="lates-news-area pt-100 pb-70 bg-f4f6f9">
         <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
               <div class="col-lg-7">
                  <div class="single-news-card style3 aos-init" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200" data-aos-once="true">
                     <div class="row align-items-center">
                  ...
                  <div class="single-news-card style3 aos-init" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400" data-aos-once="true">
                     <div class="row align-items-center">
                        <div class="col-lg-5 col-md-5">
                           <div class="news-img">
               ...
               <div class="col-lg-5 col-md-6 aos-init" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600" data-aos-once="true">
